...
class stock
{
	char name[20], pass[15];//login credential variables
	float pr; int quant;
...
int main()
{
	...
	int i, j;
	cout << "\n\n\t|============ WELCOME TO STORE inventory MANAGEMENT OF SMALL STORE ============|";
	_getch();
	system("cls");
	cout << "\n\t\t  SMALL STORE inventory  MANAGEMENT SYSTEM\n";
	cout << "==========================";
	cout << "\n\n\t\t   1. Owner Menu\n\n\t\t   2. Customer Menu\n\n\t\t   3.Staff User Menu";
	cout << "\n\n============================\n";
	cout << "\n\nEnter Your Choice:";
	...
	if (j == 1)
	{
		...
		Ownermenu:
			...
			{
				system("cls");
				disp();_getch();goto Ownermenu;
			}
			else if (i == 3)
			{
				refill();goto Ownermenu;
			}
			else if (i == 4)
			{
				remove();_getch();goto Ownermenu;
			}
			else
			{
				system("cls");
